...
const Input = ({placeholder, name, type, value, handleChange}) => {
    return <input 
     ...
     className="my-2 w-full rounded-sm outline-none bg-transparent p-2 text-white border-none text-sm white-glassmorphism  "
    />
}
            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 px-4">
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                        ...
                        <Input placeholder="Amount (ETH)" name="amountTo" type="number" handleChange={() => {}} />
